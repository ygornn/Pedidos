<?php 
  ...
  $query = $connection->query("SELECT * FROM bebida WHERE sabor LIKE '%$search%';");
?>
    ...
    <table class="table table-hover">
      ...
      <?php 
        while($data = $query->fetch(PDO::FETCH_ASSOC)){
          echo "<tr>  <td>{$data['codigo']}</td> <td><img id='image' src='../../assets/img/{$data['imagem']}'></td> <td>{$data['sabor']}</td> <td>{$data['valor']}</td> <td>{$data['marca']}</td> 
