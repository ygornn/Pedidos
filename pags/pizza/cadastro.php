...
<body>
    <main>
        <h1 class="mt-5 text-center">Cadastro de Pizzas</h1>
        <hr>
      <div class="container" style="">
      <form action="<?=URL_BASE . 'pags/pizza/acao.php'?>" method="post" enctype="multipart/form-data">
        <div class='mb-4 col-xl-2'>
          ...
          <div class="d-flex justify-content-center">
            <div class="m-3">
            <a href="pizza.php" class="btn btn-light btn-outline-danger">Consultar</a> 
          </div>
          <div class="m-3">
