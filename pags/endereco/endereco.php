    ...
    <table class="table table-hover">
      ...
      <?php 
        while($address = $query->fetch(PDO::FETCH_ASSOC)){
          ...
          <td><a class='btn btn-danger btn-sm'  name='remove' id='remove' href='acao.php?action=remove&code={$address['idendereco']}'> <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash3' viewBox='0 0 16 16'>
