...
<div class="row justify-content-center mt-5">
    ...
    <div class="card bg-light">
        ...
        <div class="card-body">
            ...
            <a class='btn btn-danger btn-sm'  name='action' id='remove' href='acao.php?action=remove&code=<?= $data['idendereco']?>'> <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash3' viewBox='0 0 16 16'>
